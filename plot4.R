...
par(mfrow = c(2,2))
plot(dataBase2$timeDate,dataBase2$Global_active_power,type="l",ylab="Global Active Power",main="",xlab="")
plot(dataBase2$timeDate,dataBase2$Voltage,type="l",main="",xlab="datetime",ylab="Voltage")
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),col=c("black","red","blue"),box.col = 0)
box()
plot(dataBase2$timeDate,dataBase2$Global_reactive_power ,type="l",main="",xlab="datetime",ylab="Global_reactive_power")
